...
# Cores do bot
COLORS = {
    "primary": discord.Color(int(CONFIG["colors"]["primary"])),
    "success": discord.Color(int(CONFIG["colors"]["success"])),
    "warning": discord.Color(int(CONFIG["colors"]["warning"])),
    "error": discord.Color(int(CONFIG["colors"]["error"])),
    "info": discord.Color(int(CONFIG["colors"]["info"])),
}
...
class ThemeSelectView(discord.ui.View):
    ...
    @discord.ui.select(
        ...
        options=[
            ...
            discord.SelectOption(label="Minimalista", value="minimalista", emoji="◻️", description="Design clean"),
            discord.SelectOption(label="Comunidade", value="comunidade", emoji="🤝", description="Comunidade geral"),
            discord.SelectOption(label="E-Girl", value="e-girl", emoji="💕", description="Estetica e-girl"),
            discord.SelectOption(label="K-Pop", value="k-pop", emoji="🎤", description="Fas de K-Pop"),
            discord.SelectOption(label="Otaku", value="otaku", emoji="🌸", description="Cultura otaku"),
        ]
    )
    async def theme_select(self, interaction: discord.Interaction, select: discord.ui.Select):
        ...
        if theme_data:
            embed = discord.Embed(
                title=f"{EMOJIS['star']} Tema Selecionado",
            ...
            await interaction.response.send_message(
                f"{EMOJIS['error']} Tema nao encontrado!",
                ephemeral=True
            )
...
class IdeasView(discord.ui.View):
    ...
    async def idea_select(self, interaction: discord.Interaction, select: discord.ui.Select):
        ...
        if theme_data:
            embed = discord.Embed(
                title=f"{EMOJIS['bulb']} Ideia Selecionada",
                description=f"**{theme_data['name']}** - {theme_data['description']}",
                color=theme_data['color']
            )
            embed.add_field(
